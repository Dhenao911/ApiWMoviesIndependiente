...
using Api.W.Movies.Backend.MoviesMapper;
...
builder.Services.AddDbContext<AplicactionDbContext>(options => options.UseSqlServer(builder.Configuration.GetConnectionString("Connection")));
